                ...
                <div>
                    <Container fluid>
                        <Row className="TopHeader">
                            ...
                            <Col><Dropdown className="dropdown" options={this.state.dropdownOptions} onChange={this.updateDashboard} value={this.selectedValue} placeholder="Select an option" /></Col>
                        </Row>
                    </Container>
                    <br/>
                    <Container>
